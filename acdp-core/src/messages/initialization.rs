...
//!
//! ```rust
//! use acdp_probe_core::messages::{InitializeRequest, ProtocolVersion, Capabilities, Implementation};
//! use serde_json::json;
//!
...
impl InitializeRequest {
    ...
    ///
    /// ```rust
    /// use acdp_probe_core::messages::InitializeRequest;
    ///
...
impl InitializeResponse {
    ...
    ///
    /// ```rust
    /// use acdp_probe_core::messages::{InitializeResponse, ProtocolVersion, Capabilities, Implementation};
    ///
    ...
    ///
    /// ```rust
    /// use acdp_probe_core::messages::InitializeResponse;
    ///
...
impl InitializedNotification {
    ...
    ///
    /// ```rust
    /// use acdp_probe_core::messages::InitializedNotification;
    ///
...
impl PingRequest {
    ...
    ///
    /// ```rust
    /// use acdp_probe_core::messages::PingRequest;
    ///
...
impl PongResponse {
    ...
    ///
    /// ```rust
    /// use acdp_probe_core::messages::PongResponse;
    ///
    ...
    ///
    /// ```rust
    /// use acdp_probe_core::messages::{PingRequest, PongResponse};
    /// use serde_json::json;
    ///
    /// let ping = PingRequest::with_timestamp("2024-01-15T10:30:00Z");
