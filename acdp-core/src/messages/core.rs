...
//!
//! ```rust
//! use acdp_probe_core::messages::core::{JsonRpcRequest, JsonRpcResponse, JsonRpcError};
//! use serde_json::json;
//!
//! // Create a request
...
impl JsonRpcRequest {
    ...
    ///
    /// ```rust
    /// use acdp_probe_core::messages::core::JsonRpcRequest;
    /// use serde_json::json;
    ///
    /// let request = JsonRpcRequest::new(
    ///     "1".to_string(),
...
impl JsonRpcResponse {
    ...
    ///
    /// ```rust
    /// use acdp_probe_core::messages::core::JsonRpcResponse;
    /// use serde_json::json;
    ///
    ...
    ///
    /// ```rust
    /// use acdp_probe_core::messages::core::{JsonRpcResponse, JsonRpcError};
    ///
...
impl JsonRpcNotification {
    ...
    ///
    /// ```rust
    /// use acdp_probe_core::messages::core::JsonRpcNotification;
    /// use serde_json::json;
    ///
...
impl JsonRpcError {
    ...
    ///
    /// ```rust
    /// use acdp_probe_core::messages::core::JsonRpcError;
    /// use serde_json::json;
    ///
